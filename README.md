...
- 📚 Learning everything but currently focusing on: OpenCV, Keras/Tensorflow, Scikit-learn, Go.
...
|☁ [Point Clouds to GIF]()|Render plain text XYZ point clouds and save them as GIF animations.|
|🏡 **Smart Home Mockup**|Presents the potential of home automation.|
